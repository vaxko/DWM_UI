...
public class MenuActionController extends LinearLayout {
	...
	public MenuActionController(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public MenuActionController(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
